REM Architettura degli Elaboratori mod. 2
REM ==============================================
REM  VM ARM Cortex-A57 con Linux Debian
REM 
REM	Dopo il boot connettersi alla VM con:
REM		$ ssh vm@localhost -p 2222
REM	password: vm
REM
REM  Per info: filippo.bergamasco@unive.it
REM


"C:\Program Files\qemu\qemu-system-aarch64" -smp 2 -M virt -cpu cortex-a57 -m 1G ^
