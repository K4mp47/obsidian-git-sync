...
-   Scarto quadratico medio viene fatto facendo la radice a Var
...
-   Per confrontare la dispersione di due variabili casuali, si usa il **coefficiente di variazione**
...
Osserviamo che, in realtà, la mediana potrebbe essere qualsiasi valore nell'intervallo $[3,4)$. In questi casi, per convenzione si usa il valore centrale: $$med(X)=\frac{3+4}{2}=3.5$$ in questo modo, la mediana coincide con la media, come avevamo stabilito per qualsiasi distribuzione simmetrica.
